...
export const initialMockJob: QuoteJob = {
  ...
  stage6VisualRef: null,
  productionRecipeId: "QUOTE_CINEMATIC_V1",
  productionRecipeVersion: "1.0",
  productionStatus: "NOT_STARTED",
  productionInputFingerprint: null,
  productionNarrationSlot: "FEMALE",
  productionVisualBrief: null,
  productionFinalAssetId: null,
  productionFailureCode: null,
  productionFailureMessage: null,
  videoStatus: "PENDING",
  videoUrlOrRef: null,
  videoProvider: null,
  videoEngine: null,
  videoProviderTaskId: null,
  videoProcessRunCount: 0,
  videoLastProcessedAt: null,
  videoLastLatencyMs: null,
